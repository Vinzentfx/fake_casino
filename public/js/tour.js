  ...
  const SCHRITTE = [
    {
      ...
      text: "Zwei Monate war zu, in der Zeit ist fast alles überarbeitet worden. In sieben Schritten zeige ich dir, wo die neuen Sachen sind. Du kannst jederzeit abbrechen und den Rundgang später über das Menü wieder öffnen.",
    },
    {
      icon: "🏠",
      titel: "Die Lobby",
    ...
    },
    {
      icon: "🎨",
      titel: "Kosmetik",
      text: "Statt Emoji und einer Schriftfarbe gibt es jetzt neun Arten: animierte Namensstile, Titel, Rahmen ums Bild, Namensschilder, Profil-Banner, Gewinn-Effekte und einen eigenen Spruch beim Reinkommen. Zwei Stücke kann man nicht kaufen.",
      ziel: "cosmetics",
      knopf: "Zum Shop",
    },
    {
