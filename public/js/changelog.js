  ...
  const RELEASES = [
    {
      ...
      items: [
        ...
        { icon: "🛡️", titel: "Clans zählen endlich mit", text: "Bisher kam Clan-Fortschritt nur aus Duell-Siegen, deshalb standen alle Clans seit Monaten still. Jetzt zählt jede Season-XP von jedem Mitglied auch für den Clan, egal welches Spiel. Die Clan-Stufen zahlen abwechselnd in die Schatzkammer und geben allen Mitgliedern bis zu 25 % mehr Season-XP." },
        { icon: "💼", titel: "Arbeiten neu: du arbeitest im Casino", text: "Die Jobs sind jetzt Rollen im Haus: Kellner, Kasse, Croupier, Sicherheit. Und die Aufgaben sind das, was man dort können muss — wechseln, richtig auszahlen, Quoten rechnen, einen falschen Wettschein erkennen. Statt Paketstapeln und Kabelfarben. Wer danebenliegt, bekommt trotzdem einen Trostlohn und erfährt die richtige Antwort. Und Arbeiten zählt jetzt für die Season mit." },
