  ...
  const RELEASES = [
    {
      ...
      items: [
        ...
        { icon: "aufwerten", titel: "Die Ziehung",
          text: "Der Bildschirm wird schwarz, die Kiste zittert und platzt auf, dann läuft die Rolle aus. Auf den letzten Metern wächst die Marke und ein Lichtkegel geht an. Die Bahn hält kurz daneben und rückt dann auf die Mitte: mal ein Stück zu weit und zurück, mal noch auf dem Stück davor und dann vorwärts. Zu sehen bekommst du eine fremde Karte nur, wenn es danach vorwärts geht — weggenommen wird dir nichts. Erst danach kommt die Karte. Ab Legendär wird der ganze Bildschirm einmal in der Farbe der Stufe gewaschen." },
