  ...
  const RELEASES = [
    {
      ...
      items: [
        ...
        { icon: "kosmetik", titel: "Die Serienlotterie",
          text: "Alles, was nicht gratis ist, bekommt beim Vergeben eine zufällige vierstellige Seriennummer, ein Prägedatum und die Kette aller Besitzer. Der Zeitpunkt zählt nicht: Klassisch fällt in 90 %, Glück in 7,5 %, Gold in 2 % und Jackpot in 0,5 % der Fälle. Besondere Muster wie #0777 oder #7777 sind dadurch echte Glücksfunde und lassen sich nicht durch frühes Öffnen erzwingen." },
