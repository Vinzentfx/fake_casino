  ...
  const RELEASES = [
    {
      ...
      items: [
        ...
        { icon: "aufwerten", titel: "Die Ziehung",
          text: "Der Bildschirm wird schwarz, die Kiste zittert und platzt auf, dann läuft die Rolle aus. Auf den letzten Metern wächst die Marke und ein Lichtkegel geht an. Die Bahn schießt dabei ein Stück über das Ziel hinaus, manchmal gerade eben bis ins nächste Feld, und rollt dann zurück, bis der Treffer genau mittig liegt. Erst danach kommt die Karte. Ab Legendär wird der ganze Bildschirm einmal in der Farbe der Stufe gewaschen." },
